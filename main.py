...
def game():
    ...
    while alive:
        ...
        print(
            f"A: {compare[0]['name']}, {compare[0]['description']} from {compare[0]['country']}"
        )
        print(art.vs)
        print(
            f"B: {compare[1]['name']}, {compare[1]['description']} from {compare[1]['country']}"
        )
    ...
    print(
        f"\nThat one was wrong but you still got the score of {count} and you should feel good about that."
    )
